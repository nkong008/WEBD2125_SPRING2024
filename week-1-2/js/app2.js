...
//   console.log(x);
  ...
  for (i = 0; i < x.length; i++) {
    // does the math inside the () and helps create unique ID
    // you know your loop is working
    artistList += '<div class="artists" id="artist' + (i + 1) + '">';
    artistList +=
      '<section class="artist-section"><h1>Artist:' +
    ...
    artistList +=
      ...
      "</h4>";
    artistList +=
      '<h4>Artist Bio: </h4><section class="bio"><p>' +
      x[i].getElementsByTagName("bio")[0].childNodes[0].nodeValue + "</p>" +
      '<img src="images2/' +
...
//   let artistDiv = document.getElementsByTagName("div");
